"""
Copied from the Official TorchVision Object-Detection [Tutorial](https://pytorch.org/tutorials/intermediate/torchvision_tutorial.html)
...
class Compose(object):
    def __init__(self, transforms, img_transforms):
    ...
    def __repr__(self):
        return str(self.transforms + self.img_transforms)
